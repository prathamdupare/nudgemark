        ...
        <div className="space-y-8 max-w-3xl">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Our Terms and Conditions were last updated on 02/02/2025.
            </p>
            <p className="mb-4">
          ...
          <section id="copyright">
            ...
            <p className="mb-4">
              ...
              are the exclusive property of NudgeMark and are protected by
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                the copyright owner or authorized to act on the copyright owner
                &apos; s behalf.
              </li>
            </ul>
            <p className="mt-4">
              ...
              <Link
                href="mailto:copyright@nudgemark.com"
          ...
          <section id="feedback">
            ...
            <p>
              ...
              to use, reproduce, disclose, sublicense, distribute, modify, and
          ...
          <section id="changes">
            ...
            <div className="space-y-4">
              ...
              {`We reserve the right, at Our sole discretion, to modify or
                ...
                before any new terms take effect. What constitutes a material
