      ...
      <div className="grid lg:grid-cols-[250px_1fr] gap-8">
        ...
        <Card className="p-4 h-fit sticky top-4 hidden lg:block">
          ...
          <ScrollArea className="h-[calc(100vh-200px)]">
            <nav className="space-y-2">
              ...
              <a href="#information-collection" className="block text-sm hover:underline">
                Information We Collect
              </a>
              <a href="#information-usage" className="block text-sm hover:underline">
        ...
        <div className="space-y-8 max-w-3xl">
          <div>
            ...
            <p className="text-muted-foreground mb-4">Our Privacy Policy was last updated on 02/02/2025.</p>
            <p className="mb-4">
              At NudgeMark, one of our main priorities is the privacy of our visitors. This Privacy Policy document
              contains types of information that is collected and recorded by NudgeMark and how we use it.
            </p>
            <p className="mb-4">
            ...
            <p>
              ...
              regards to the information that they shared and/or collected on https://nudgemark.com/. This policy is not
          ...
          <section id="log-files">
            ...
            <p className="mb-4">
              NudgeMark follows a standard procedure of using log files. These files log visitors when they visit
              websites. All hosting companies do this as part of hosting services' analytics.
            </p>
            <p>
          ...
          <section id="cookies">
            ...
            <p className="mb-4">
              Like any other website, NudgeMark uses 'cookies'. These cookies are used to store information including
          ...
          <section id="advertising">
            ...
            <p className="mb-4">
              ...
              used in their respective advertisements and links that appear on NudgeMark, which are sent directly to
              users' browsers. They automatically receive your IP address when this occurs. These technologies are used
            ...
            <p>
              Note that NudgeMark has no access to or control over these cookies that are used by third-party
              advertisers.
            </p>
          </section>
          ...
          <section id="third-party">
            ...
            <p className="mb-4">
              NudgeMark's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
          ...
          <section id="children">
            ...
            <p>
              NudgeMark does not knowingly collect any Personal Identifiable Information from children under the age of
