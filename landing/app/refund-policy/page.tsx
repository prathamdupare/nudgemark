        ...
        <div className="space-y-8 max-w-3xl">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Our Return and Refund Policy was last updated on 02/02/2025.
            </p>
          ...
          <section id="refund-period">
            ...
            <Alert className="border-blue-200 ">
              ...
              <AlertDescription>
                Refund requests must be made within <strong>10 days</strong> of
                the payment date. Requests made after this period will not be
